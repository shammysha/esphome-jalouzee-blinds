    ...
    public Component
{
 ...
 protected:
  ...
  GPIOPin *calibration_button_ =
      nullptr;



  GPIOPin *cancel_button_ =
      nullptr;
  ...
  bool last_calibration_button_ =
      false;



  bool last_cancel_button_ =
      false;
