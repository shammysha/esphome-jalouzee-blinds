...
void Calibration::start()
{
  ...
  ESP_LOGI(
      TAG,
      "Calibration started. Waiting for CLOSED position"
  );
...
void Calibration::set_closed_angle(
    float angle
)
{
  ...
  state_ =
      CalibrationState::WAIT_OPEN;



  ESP_LOGI(
      TAG,
      "Closed angle stored: %.2f",
      closed_angle_
  );
...
void Calibration::set_open_angle(
    float angle
)
{
